 ...
 * oracle分页
 */
public class OracleSelectByPagePlugin extends PluginAdapter {
...
//        sb.append("          <if test=\"_parameter != null\" > <include refid=\"Example_Where_Clause\"/>          and  </if>"); //and暂时取消
...
//                                + " \r\n     -->"));
        ...
        sb.append("          ( SELECT A.*, ROWNUM RN  FROM (SELECT * FROM ");
        sb.append(introspectedTable.getAliasedFullyQualifiedTableNameAtRuntime() +"\r\n");
        sb.append("           <if test=\"oredCriteria[0].criteria.size > 0  \"> \r\n");
        sb.append("              <include refid=\"select_by_page_outter_where_sql\"/> \r\n");
        sb.append("            </if>  \r\n ");
        sb.append("             ) A ) where  RN BETWEEN ${(pageIndex-1)*pageSize} AND ${pageSize} \r\n");
        sb.append("             <if test=\"oredCriteria[0].criteria.size==0\"> \r\n ");
